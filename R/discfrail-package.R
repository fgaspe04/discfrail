...
##'
##' \code{\link{sim_npdf}} simulates from a proportional hazards model with a flexible baseline survival distribution and discrete shared frailty terms.
##'
##' \code{\link{sim_weibdf}} simulates from a Weibull survival model with shared discrete frailty terms. 
##'
##' 
