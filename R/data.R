...
#'
#' \code{sim_npdf( N=100, S=40, beta=1.6, Lambda_0_inv = function( t, c=0.01, d=4.6 ) ( t^( 1/d ) )/c,
#'                 p=c(0.8, 0.2), w_values = c(0.8, 1.6), cens_perc = 0.1 )}
#'
#'
"weibdata"
...
#' The dataset was generated by \code{\link{sim_npdf}} as follows.
#'
#' \code{sim_npdf( N=20, S=30, beta=1.6, Lambda_0_inv = function( t, c=0.01, d=4.6 ) ( t^( 1/d ) )/c, p=c(0.6, 0.4), w_values = c(0.8, 1.6), cens_perc = 0.1 )}
#'
"weibdata20"
